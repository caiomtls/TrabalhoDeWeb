...
;(function (factory) {
    ...
    DataTable.defaults = {
        ...
        /**
         * This parameter allows you to readily specify the  in the length drop
         ...
         * (i.e. "Showing 1 to 10 of 57 ") DataTables will render large numbers
